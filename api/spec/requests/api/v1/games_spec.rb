  ...
  describe 'GET /api/v1/games/:game_id' do
    ...
    context 'when an authenticated user' do
      it 'loads a game' do
        ...
        get api_v1_game_path(game), headers: { 'ACCEPT' => 'application/json' }
  ...
  describe 'POST /api/v1/games' do
    context 'when an authenticated user' do
      it 'create a game with quizzes' do
        authenticated_user_stub(user)
        expect do
          post api_v1_games_path, params: game_with_quizzes_params(user), headers: { 'ACCEPT' => 'application/json' }
  ...
  describe 'PUT /api/v1/games/:game_id' do
    ...
    context 'when an authenticated user' do
      it 'creater of the game can update the game' do
        ...
        put api_v1_game_path(game), params: game_params, headers: { 'ACCEPT' => 'application/json' }
